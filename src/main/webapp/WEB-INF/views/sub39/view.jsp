...
<body>
	...
	<div>
		<button id="btn5">555</button>
	</div>
	<div>
		<button id="btn6">666</button>
	</div>
	<div>
		<button id="btn7">777</button>
	</div>
	<div>
		<button id="btn8">888</button>
	</div>
	<div>
		<button id="btn9">본문있는 성공 응답</button>
	</div>
	<div>
		<button id="btn10">현재시간</button>
		<div id="res10"></div>
	</div>
	<div>
	...
	<div>
		<button id="btn13">JSON 응답</button>
	</div>
	<div>
