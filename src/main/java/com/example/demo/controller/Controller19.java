...
//			pstmt.setString(2, "1811-11-12 23:50:49");
	...
	public void method5() throws Exception {
		...
		try (
			...
			pstmt.setInt(2, 31);
			pstmt.setDouble(3, 50000.32);
			pstmt.setDate(4, Date.valueOf("1992-08-15"));
			pstmt.setTimestamp(5, Timestamp.valueOf("2023-04-20 09:44:32"));
	...
	public void method13() throws Exception {
		...
		try (
			...
			if (rs.next()) {
				...
				System.out.println("입력시간: " + inserted);
			}
